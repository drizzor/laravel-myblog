<x-master>
    ...
    <main class="post blog-post col-lg-8"> 
        ...
        <div class="post-single">
            <div class="post-thumbnail"><img src="https://source.unsplash.com/pduutGbL2-M" alt="..." class="img-fluid"></div>
            ...
            <div class="post-body">
                ...
                <p> <img src="https://source.unsplash.com/KQ0C6WtEGlo" alt="..." class="img-fluid"></p>
            ...
            <div class="post-comments">
                ...
                <div class="comment-header d-flex justify-content-between">
                    ...
                    <div class="image"><img src="https://avatars.dicebear.com/api/bottts/Jabi.svg" alt="..." class="img-fluid rounded-circle"></div>
                ...
                <div class="comment-header d-flex justify-content-between">
                    <div class="user d-flex align-items-center">
                    <div class="image"><img src="https://avatars.dicebear.com/api/bottts/Nikolas.svg" alt="..." class="img-fluid rounded-circle"></div>
                ...
                <div class="comment-header d-flex justify-content-between">
                    <div class="user d-flex align-items-center">
                    <div class="image"><img src="https://avatars.dicebear.com/api/bottts/John.svg" alt="..." class="img-fluid rounded-circle"></div>
